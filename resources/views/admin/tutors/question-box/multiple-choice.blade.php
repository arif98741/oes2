            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group" style="float: left;margin-right: 10px;">
                            <label for="exampleInputName2">&nbsp;</label>
                            <div class="select">
                                <a class="btn btn-warning" href="{{route('manage_question_type',2)}}">Back</a>
                            </div>
                        </div>
                    <!-- <div class="form-group" style="float: left;margin-right: 10px;">
                        <label for="exampleInputName2">&nbsp;</label>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    for ($i = 1; $i <= 3; $i++) {
                    ?>
                    <div class="row list_box_class editor_hide" id="list_box_<?php echo $i;?>" style="align-items: center;margin-bottom: 10px;">
                        <div class="col-2">
                    ...
                    <div class="row list_box_class editor_hide" id="list_box_<?php echo $desired_i;?>" style="align-items: center;display: none;margin-bottom: 10px;">
                        <div class="col-2">
