...
@section('body')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-0">
                            ...
                            <input type="number" class="form-control form-check" value="{{$question->mark}}" min="1" id="mark_value" placeholder="Set Question Mark" name="question_mark">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        @endphp
                        <div class="col-sm-7">
                            <input class="form-control" type="number" value="{{count($question_answer->answer_choice)}}" id="box_qty" onclick="getImageBox(this)">
                        </div>
                    </div>
                    <?php
                        $question_answer = json_decode($question->answer);
                    ...
                    ?>
                    <div class="row editor_hide" id="list_box_<?php echo $i;?>" style="align-items: center;margin-bottom: 10px;">
                        <div class="col-2">
                    ...
                    <div class="row editor_hide" id="list_box_<?php echo $desired_i;?>" style="align-items: center;display: none;margin-bottom: 10px;">
                        <div class="col-2">
    ...
    <input type="hidden" name="image_quantity" id="image_quantity" value="{{count($question_answer->answer_choice)}}">
    </form>
