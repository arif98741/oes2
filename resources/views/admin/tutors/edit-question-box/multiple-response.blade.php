            ...
            <div class="page-title-box">
                <div class="btn-group float-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">Multiple Response</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row " id="list_box_<?php echo $i;?>" style="align-items: center;margin-bottom: 10px;">
                        ...
                        <div class="col-1">
                            <p class="ss_lette" style="height: 100px;line-height: 100px;background:#eee;text-align: center; ">
                                <input type="checkbox" name="response_answer[]" value="<?php echo $i;?>" style="text-align: center;font-size: 24px;">
                            </p>
                        </div>
                    </div>
                    <?php }?>
                    ...
                    <div class="row " id="list_box_<?php echo $desired_i;?>" style="align-items: center;display: none;margin-bottom: 10px;">
                        ...
                        <div class="col-1">
                            <p class="ss_lette" style="height: 100px;line-height: 100px;background:#eee;text-align: center; ">
                                <input type="checkbox" name="response_answer[]" value="<?php echo $desired_i;?>" style="text-align: center;font-size: 24px;">
                            </p>
                        </div>
                    </div>
                    <?php } ?>
