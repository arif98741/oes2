        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-right">
                    <a class="btn btn-primary btn-sm" href="{{route('admin.add_member')}}">Add New</a>
                </div>

                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-hover" id="members_data">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Email</th>
...
<script>
    $(document).ready(function() {
        $('#members_data').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "{{route('admin.get_members_list')}}",
        } );
    });
