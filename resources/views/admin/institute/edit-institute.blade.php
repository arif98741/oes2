...
@section('body')
    ...
    @endif
    <form id="question_form" action="{{route('edit_institute',$institute->id)}}" method="post">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" type="text" value="{{$institute->institute_name}}" name="institute_name" placeholder="Institute name">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" type="text" value="{{$institute->principal_name}}" name="principal_name" placeholder="Principal name">
                                    </div>
                                    <span id="student_grade_msg"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" readonly="readonly" type="text" value="{{$institute->principal_email}}" placeholder="Principal email">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" type="text" value="{{$institute->principal_phone}}" name="principal_phone" placeholder="Principal Phone">
                                    </div>
                                    <span id="student_grade_msg"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" readonly="readonly" value="{{$institute->admin_email}}" type="text" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" value="{{$institute->admin_phone}}" type="text" name="admin_phone" placeholder="Admin phone">
                                    </div>
                                    <span id="student_grade_msg"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input class="form-control" value="{{$institute->address}}" type="text" name="address" placeholder="Address">
                                    </div>
                                    <span id="student_grade_msg"></span>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <select class="form-control select-hidden form-check"  name="type">
                                            ...
                                            <option @php echo($institute->type == $institute_type['id']) ? 'selected' : '' @endphp value="{{$institute_type['id']}}">{{$institute_type['name']}}</option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <select class="form-control select-hidden form-check"  name="status">
                                            <option @php echo($institute->status == 1) ? 'selected' : '' @endphp  value="1">Active</option>
                                            <option @php echo($institute->status == 0) ? 'selected' : '' @endphp value="0">Inactive</option>
