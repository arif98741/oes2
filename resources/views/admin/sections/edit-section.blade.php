        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-5">
                        <h3 class="text-center admin-color">Edit Section</h3>
                        @if ($errors->any())
                        ...
                        @endif
                        <form class="form-horizontal" action="{{route('update_section',$section->id)}}" method="post">
                            @csrf
                                        ...
                                        <div class="select">
                                            <select class="form-control select-hidden form-check" name="level_id">
                                                ...
                                                @foreach($levels as $level)
                                                    <option value="{{$level->id}}" @if($section->level_id == $level->id) selected @endif>
                                                        {{$level->level_name}}
                                                    </option>
                                                @endforeach
                                            </select>
