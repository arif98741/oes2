...
@section('body')
    ...
    @endif
    <form id="question_form" action="{{route('add_post')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-10">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input required="required" class="form-control" type="text" name="post_title" placeholder="title">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <input type="text" placeholder="Enter post slug" required="required" class="form-control" name="slug" id="slug">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" >
                                    ...
                                    <div class="select">
                                        <textarea required="required" class="form-control" name="content" id="summernote"></textarea>
                                    </div>
