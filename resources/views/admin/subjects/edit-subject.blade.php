        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-5">
                        <h3 class="text-center admin-color">Edit Subject</h3>
                        @if ($errors->any())
                        ...
                        @endif
                        <form class="form-horizontal" action="{{route('update_subject',$subject->id)}}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                        ...
                                        <div class="select">
                                            <select class="form-control select-hidden form-check" name="level_id">
                                                ...
                                                @foreach($levels as $level)
                                                    <option value="{{$level->id}}" @if($subject->level_id == $level->id) selected @endif>
                                                        {{$level->level_name}}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subject" value="{{$subject->subject_name}}" class="form-control">
                                    </div>
                                </div>
