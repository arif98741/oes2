        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body row">
                    ...
                    {{--</a>--}}
                    <div class="col-7">
                        <h3 class="text-center admin-color">Subject List</h3>
                        <table class="table table-hover">
                            ...
                            @foreach($subjects as $key=>$subject)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('edit_subject', ['id' =>$subject->id])}}" class="btn btn-warning btn-animation">
                                            Edit
                                        </a>
                                        <a class="btn btn-danger delete-btn" href="#" onclick="DeleteSubject({{$subject->id}})">delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                    ...
                    <div class="col-5">
                        <h3 class="text-center admin-color">Add Subject</h3>
                        @if ($errors->any())
                        ...
                        @endif
                        <form class="form-horizontal" action="{{action('SubjectController@manage_subject')}}" method="post">
                            @csrf
